...
;==============================================================================
    ...
    IMPORT UART_AMOSI_pinNumber
    IMPORT UART_AMOSI_pinPortNumber
    IMPORT UART_AMOSI_pinDrAdress
...
;-------------------------------------------------------------------------------
; Function Name: UART_AMOSI_PutChar
;-------------------------------------------------------------------------------
;
; Summary:
...
; void UART_AMOSI_PutChar(uint8 txDataByte)
    ALIGN 8
UART_AMOSI_PutChar FUNCTION
    EXPORT UART_AMOSI_PutChar
...
PIN_NUMBER DCD UART_AMOSI_pinNumber
PORT_NUMBER DCD UART_AMOSI_pinPortNumber
PORT_DR_ADDRESS DCD UART_AMOSI_pinDrAdress

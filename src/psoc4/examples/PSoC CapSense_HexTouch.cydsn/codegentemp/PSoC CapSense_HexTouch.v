// ======================================================================
// PSoC CapSense_HexTouch.v generated from TopDesign.cysch
// 03/13/2024 at 17:59
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDACComp, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mux_CapSense:IDACComp, CY_INSTANCE_SHORT_NAME=IDACComp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Mux_CapSense_IDACComp, )
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDACMod, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mux_CapSense:IDACMod, CY_INSTANCE_SHORT_NAME=IDACMod, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Mux_CapSense_IDACMod, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=1000, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=true, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=false, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_micros, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_micros, CY_INSTANCE_SHORT_NAME=Counter_micros, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Counter_micros, )
...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONFIG_TITLE=UART_AMOSI, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_AMOSI, CY_INSTANCE_SHORT_NAME=UART_AMOSI, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=UART_AMOSI, )
module SW_Tx_UART_v1_50_8 ;
...
module top ;
    ...
    CapSense_P4_v7_10_2 Mux_CapSense ();

    Counter_v3_0_3 Counter_micros (
        .capture(1'b0),
        .clock(Net_106),
        .comp(Net_2194),
        .count(Net_2394),
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Counter_micros.CaptureMode = 0;
    defparam Counter_micros.ClockMode = 0;
    defparam Counter_micros.CompareMode = 0;
    defparam Counter_micros.CompareStatusEdgeSense = 1;
    defparam Counter_micros.EnableMode = 0;
    defparam Counter_micros.ReloadOnCapture = 0;
    defparam Counter_micros.ReloadOnCompare = 0;
    defparam Counter_micros.ReloadOnOverUnder = 1;
    defparam Counter_micros.ReloadOnReset = 0;
    defparam Counter_micros.Resolution = 32;
    defparam Counter_micros.RunMode = 0;
    defparam Counter_micros.UseInterrupt = 1;
    ...
    SW_Tx_UART_v1_50_8 UART_AMOSI ();

    assign Net_2203 = 1'h1;

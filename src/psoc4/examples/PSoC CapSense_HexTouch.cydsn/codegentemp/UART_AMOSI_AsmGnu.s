...
.global UART_AMOSI_pinNumber
.global UART_AMOSI_pinPortNumber
...
.global UART_AMOSI_PutChar
.func UART_AMOSI_PutChar, UART_AMOSI_PutChar
.type UART_AMOSI_PutChar, %function
.thumb_func
UART_AMOSI_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word UART_AMOSI_pinNumber
PORT_NUMBER:
    .word UART_AMOSI_pinPortNumber
PORT_DR_ADDRESS:
    .word UART_AMOSI_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 115200
